  ...
  render() {
    return (
      <div className="mx-0">
          ...
          <div style={{width:'30%', height:'305px', marginLeft:'2.5%'}} className="border float-left mt-4">
          ...
          <div style={{width:'30%', marginLeft:'2.5%'}} className="border float-left mt-4" key={index}>
            ...
            {item.title} - ${item.price}
              ...
              <div style={{width:'50%'}} className="float-right pt-2 pl-5">
                <button type="button" className="float-right w-25 mr-2" onClick={this.deletePhoto.bind(this, item.id)}>
                    <i className="fas fa-trash"></i>
                </button>
                <Link to={`/editprod/${item.id}`}><button type="button" className="float-right w-25 mr-2">
